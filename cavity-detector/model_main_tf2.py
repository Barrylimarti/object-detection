...
def main(_):
    ...
    if FLAGS.checkpoint_dir:
        ...
        if FLAGS.run_once:
            ...
            model_lib_v2.continuous_eval(estimator, FLAGS.checkpoint_dir, input_fn,
                                         train_steps, name, FLAGS.max_eval_retries)
    else:
        train_spec, eval_specs = model_lib_v2.create_train_and_eval_specs(
            train_input_fn,
            eval_input_fns,
